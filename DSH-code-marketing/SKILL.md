...
| [capture_table.R](file:///d:/R/.agents/skills/DSH-code-marketing/scripts/capture_table.R) | `capture_table(data_path, target, nrows=5)` | 数据表截图（动态列宽适配，GitHub 表格样式） | knitr, webshot2 |
