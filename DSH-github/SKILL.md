---
name: "DSH-github"
description: "GitHub 仓库管理：创建仓库、推送代码、上传技能。内置 shongdai 账号配置模板，需替换 Token。当用户要求推送代码到 GitHub、创建仓库、或管理 GitHub 资源时调用。"
---
...
> **使用前**：将 `<<GITHUB_TOKEN_PLACEHOLDER>>` 替换为你的 GitHub Personal Access Token。
...
git remote add origin "https://shongdai:<<GITHUB_TOKEN_PLACEHOLDER>>@github.com/shongdai/REPO.git"
